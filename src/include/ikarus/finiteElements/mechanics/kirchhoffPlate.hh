...
namespace Ikarus {
  ...
  struct KirchhoffPlateAD : Ikarus::ScalarFieldFE<Basis>, Ikarus::AutoDiffFE<KirchhoffPlateAD<Basis>, Basis> {
    using BaseDisp = Ikarus::ScalarFieldFE<Basis>;
    using BaseAD   = Ikarus::AutoDiffFE<KirchhoffPlateAD<Basis>, Basis>;
    using BaseAD::size;
    using LocalView         = typename Basis::LocalView;
    using FERequirementType = typename BaseAD::FERequirementType;

    KirchhoffPlateAD(const Basis& basis, const typename LocalView::Element& element, double p_Emodul, double p_nu,
                     double p_thickness)
